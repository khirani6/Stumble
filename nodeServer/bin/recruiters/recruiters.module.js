...
const recruiter_schema_1 = require("./schemas/recruiter.schema");
let RecruitersModule = class RecruitersModule {
};
RecruitersModule = __decorate([
    common_1.Module({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Recruiter', schema: recruiter_schema_1.RecruiterSchema }])],
